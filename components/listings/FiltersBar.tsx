...
export function FiltersBar({ filters, onFilterChange, onToggleDrawer }: FiltersBarProps) {
  ...
  return (
    <div className="bg-white/95 backdrop-blur-sm rounded-lg shadow-medium p-6 mb-8 sticky top-20 z-30 border border-brown-dark/10">
      ...
      {onToggleDrawer && (
        <Button variant="outline" className="w-full mt-4 md:hidden" onClick={onToggleDrawer}>
